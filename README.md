...
page; the snippets below use `1.0.4` as an example.
...
```
jcr_root/apps/myproject-vendor-packages/container/install/ceros-aem-connector-all-1.0.4.zip
```
...
```
https://repo1.maven.org/maven2/com/ceros/ceros-aem-connector-all/1.0.4/ceros-aem-connector-all-1.0.4.zip
```
